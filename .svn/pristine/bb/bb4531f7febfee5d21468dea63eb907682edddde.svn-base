		...
		<div class="all_box">
			...
			<p>
				<b> Margin Cost:</b><span><em
					style="font-size: 20px; margin-left: 5px; color: red;">${margin}
				</em>RMB</span>
			</p>
			...
			<input id="item_number" type="hidden" name="item_number"
				...
				type="hidden" name="amount" value="${margin}"> <input
				...
				value="${ctx}/SteelPlate/findOrderByItemId.do?itemId=${itemId}">
			...
			<div class="dibu">
				...
				</a> <a href="#"> <input onclick="cancel_order()" class="div_button03"
					value="Cancel">
				</a>
			</div>
		</div>
