...
<div class="w-btn">
    <div class="w-last">
        <a href="mailto:RFQ@CSMFG.COM?subject=Fabrication Inquiry:${clientOrder.quoteId}" onclick="gtag_report_conversion('http://calculator.metal-work.com/steelPlate/calculator/queryAll.do')"><button class="btn btn-info btn-large">Email drawings to get precise quotes</button></a> 
    </div>
