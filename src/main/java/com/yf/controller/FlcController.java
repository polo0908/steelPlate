...
@Controller
@RequestMapping("/fclChinese")
public class FlcController {
	public static Logger logger = Logger.getLogger(FlcController.class);
	...
	@RequestMapping("/queryByFclPort")
	public void queryByFclPort(HttpServletRequest request, HttpServletResponse response) throws Exception {
	 ...
	 * @throws IOException
	 */
	@RequestMapping("/queryByFclHotPort")
	public void queryByFclHotPort(HttpServletRequest request, Model model, HttpServletResponse response)
			throws Exception {
